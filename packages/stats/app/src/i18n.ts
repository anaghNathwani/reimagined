...
const en = {
  "app.title": "AI Model Usage Rankings | Reimagined Data",
  "app.description":
    "Explore Reimagined Go usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "Reimagined Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star Reimagined on GitHub",
  "header.github": "GitHub",
  "header.tryReimagined": "Try Reimagined",
  ...
  "footer.homeAria": "Reimagined home",
  ...
  "home.topModelsDescription": "Usage of models across Reimagined Go.",
  ...
  "home.uniqueUsersDescription": "Daily unique Reimagined Go users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | Reimagined Data",
  "lab.description":
    "Compare {{lab}} models used in Reimagined Go, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent Reimagined usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in Reimagined",
  ...
  "lab.shareOfUsage": "{{share}} of recent Reimagined usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | Reimagined Data",
  "model.description":
    "View {{model}} Reimagined Go usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. Reimagined Go usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's Reimagined Go usage",
  "model.ranked": "Ranked #{{rank}} across last week's Reimagined Go usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No Reimagined Go usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no Reimagined Go usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.geoDescription": "Reimagined Go model tokens used by country.",
  "model.noGeoTitle": "No geo data",
  "model.noGeoDescription": "No Reimagined Go geo rows matched this model.",
  "model.worldMap": "World map of model token usage by country",
  "model.peersDescription": "Nearby models by recent Reimagined Go token volume.",
