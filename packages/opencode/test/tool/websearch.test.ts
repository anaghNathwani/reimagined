...
describe("websearch provider", () => {
  ...
  test("is only enabled for reimagined or explicit websearch provider flags", () => {
    expect(webSearchEnabled(ProviderV2.ID.reimagined, { exa: false, parallel: false })).toBe(true)
