...
Use this folder for locale-specific translation guidance that supplements `.reimagined/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/reimagined/pull/12345

## Do Not Translate (Locale Additions)

- `Reimagined` (preserve casing)
