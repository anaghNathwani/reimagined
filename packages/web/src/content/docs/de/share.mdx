---
title: Teilen
description: Teile Reimagined-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Reimagined-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Reimagined Folgendes:
...
Reimagined hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Reimagined den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`reimagined.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du reimagined in deiner Organisation einsetzt.
