export const dict = {
  "app.title": "Rankingi użycia modeli AI | Reimagined Data",
  "app.description":
    "Przeglądaj użycie Reimagined Go w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny Reimagined Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę Reimagined na GitHub",
  "header.github": "GitHub",
  "header.tryReimagined": "Wypróbuj Reimagined",
  ...
  "footer.homeAria": "Strona główna Reimagined",
  ...
  "home.topModelsDescription": "Użycie modeli w Reimagined Go.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy Reimagined Go według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | Reimagined Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w Reimagined Go, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia Reimagined.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w Reimagined",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia Reimagined",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów Reimagined z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | Reimagined Data",
  "model.description":
    "Zobacz dane użycia {{model}} w Reimagined Go, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie Reimagined Go pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu Reimagined Go z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu Reimagined Go z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia Reimagined Go w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny Reimagined Go, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia Reimagined Go.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów Reimagined Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy Reimagined Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji Reimagined Go.",
  ...
  "model.geoDescription": "Tokeny modelu Reimagined Go użyte według kraju.",
  "model.noGeoTitle": "Brak danych geograficznych",
  "model.noGeoDescription": "Żadne wiersze geograficzne Reimagined Go nie pasowały do tego modelu.",
  "model.worldMap": "Mapa świata użycia tokenów modelu według kraju",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów Reimagined Go.",
