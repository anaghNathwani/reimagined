---
title: ACP
description: Używanie Reimagined z protokołem Agent Client Protocol (ACP).
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Reimagined obsługuje [Agent Client Protocol](https://agentclientprotocol.com) (ACP), który umożliwia korzystanie z Reimagined bezpośrednio w edytorach i środowiskach IDE.
...
Aby używać Reimagined przez ACP, skonfiguruj swój edytor tak, aby uruchamiał polecenie `reimagined acp`.

Uruchamia to Reimagined jako podproces zgodny z ACP, który komunikuje się z edytorem za pomocą JSON-RPC przez stdio.
...
Następnie wybierz „Reimagined” w selektorze agentów AI Chat.
...
Aby używać Reimagined jako agenta ACP w [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), dodaj następującą konfigurację do Neovim:
...
Ta konfiguracja sprawia, że CodeCompanion używa Reimagined jako agenta ACP do czatu.
...
Reimagined działa przez ACP tak samo, jak w terminalu. Obsługiwane są wszystkie główne funkcje:
...
- Serwery MCP zdefiniowane w konfiguracji Reimagined
