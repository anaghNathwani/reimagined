---
title: LSP-servere
description: Reimagined integreres med dine LSP-servere.
---

Reimagined kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

Reimagined leveres med flere indbyggede LSP-servere til populære sprog:
...
Når LSP er aktiveret, og reimagined åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din reimagined-konfiguration.
