export const dict = {
  ...
  "dialog.provider.reimagined.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.reimagined.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.reimaginedGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Reimagined",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Reimagined.",
  ...
  "provider.connect.reimaginedZen.line1":
    "Reimagined Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.reimaginedZen.visit.prefix": "Besøg ",
  "provider.connect.reimaginedZen.visit.link": "reimagined.ai/zen",
  "provider.connect.reimaginedZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Reimagined.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Reimagined.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i reimagined.json",
  ...
  "dialog.server.description": "Skift hvilken Reimagined-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker Reimagined...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker Reimagined i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer Reimagined...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer Reimagined i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater Reimagined i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater Reimagined",
  ...
  "wsl.onboarding.distroStatus.reimaginedMissing": "Reimagined er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Reimagined kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Reimagined kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Reimagined igen.",
  ...
  "toast.update.description": "En ny version af Reimagined ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Reimagined-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (reimagined.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Reimagined understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Reimagined inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Reimagined-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Reimagined",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Reimagined ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om Reimagined følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Reimagined er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Reimagined starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Reimagined.",
