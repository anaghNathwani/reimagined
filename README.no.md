...
brew install anomalyco/tap/reimagined # macOS og Linux (anbefalt, alltid oppdatert)
brew install reimagined              # macOS og Linux (offisiell brew-formel, oppdateres sjeldnere)
...
Reimagined er også tilgjengelig som en desktop-app. Last ned direkte fra [releases-siden](https://github.com/anomalyco/reimagined/releases) eller [reimagined.ai/download](https://reimagined.ai/download).
...
Reimagined har to innebygde agents du kan bytte mellom med `Tab`-tasten.
...
Les mer om [agents](https://reimagined.ai/docs/agents).

### Dokumentasjon

For mer info om hvordan du konfigurerer Reimagined, [**se dokumentasjonen**](https://reimagined.ai/docs).

### Bidra

Hvis du vil bidra til Reimagined, les [contributing docs](./CONTRIBUTING.md) før du sender en pull request.

### Bygge på Reimagined

Hvis du jobber med et prosjekt som er relatert til Reimagined og bruker "reimagined" som en del av navnet; for eksempel "reimagined-dashboard" eller "reimagined-mobile", legg inn en merknad i README som presiserer at det ikke er bygget av Reimagined-teamet og ikke er tilknyttet oss på noen måte.

---

**Bli med i fellesskapet** [Discord](https://discord.gg/reimagined) | [X.com](https://x.com/reimagined)
