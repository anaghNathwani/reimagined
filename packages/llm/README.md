...
Schema-first LLM core for reimagined. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@reimagined-ai/llm"
import { OpenAI } from "@reimagined-ai/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@reimagined-ai/llm/providers"
