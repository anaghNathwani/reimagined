export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | Reimagined Data",
  "app.description":
    "Reimagined Go kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde Reimagined Data logosu",
  ...
  "header.githubAria": "GitHub'da Reimagined'a yıldız ver",
  "header.github": "GitHub",
  "header.tryReimagined": "Reimagined'u dene",
  ...
  "footer.homeAria": "Reimagined ana sayfası",
  ...
  "modal.title": "Reimagined Bülteni",
  ...
  "home.topModelsDescription": "Reimagined Go genelinde model kullanımı.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz Reimagined Go kullanıcıları.",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | Reimagined Data",
  "lab.description":
    "Reimagined Go'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  "lab.loadingTitle": "Model Laboratuvarı",
  "lab.loadingDescription": "Model kullanılabilirliği ve son Reimagined kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "Reimagined'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son Reimagined kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük Reimagined token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | Reimagined Data",
  "model.description":
    "{{model}} için Reimagined Go kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda Reimagined Go kullanımı görünür.",
  "model.unranked": "Geçen haftaki Reimagined Go kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki Reimagined Go kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde Reimagined Go kullanımı yok.",
  ...
  "model.overviewDescription": "Son Reimagined Go tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz Reimagined Go kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük Reimagined Go token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz Reimagined Go kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama Reimagined Go oturum yapısı.",
  ...
  "model.geoDescription": "Ülkeye göre kullanılan Reimagined Go model tokenları.",
  "model.noGeoTitle": "Coğrafi veri yok",
  "model.noGeoDescription": "Bu modelle eşleşen Reimagined Go coğrafi satırı yok.",
  "model.worldMap": "Ülkeye göre model token kullanımının dünya haritası",
  "model.peersDescription": "Son Reimagined Go token hacmine göre yakındaki modeller.",
