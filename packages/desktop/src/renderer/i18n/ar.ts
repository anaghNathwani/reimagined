export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من Reimagined",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من Reimagined، هل ترغب في تثبيته وإعادة تشغيله؟",
