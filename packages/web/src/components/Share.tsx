...
import type { MessageV2 } from "reimagined/session/message-v2"
import type { Message } from "reimagined/session/message"
import type { Session } from "reimagined/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.reimagined_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.reimagined_name}>
