...
import { LLM, LLMClient, Message, ProviderID, Tool, ToolRuntime } from "@reimagined-ai/llm"
import { Route, Auth, Endpoint, Framing, Protocol, RequestExecutor, WebSocketExecutor } from "@reimagined-ai/llm/route"
...
const rawOverlayExample = LLM.request({
  ...
  http: {
    ...
    headers: { "x-reimagined-tutorial": "1" },
    query: { debug: "1" },
  },
})
