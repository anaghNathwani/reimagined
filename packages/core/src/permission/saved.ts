...
import { PermissionSaved } from "@reimagined-ai/schema/permission-saved"
...
export class Service extends Context.Service<Service, Interface>()("@reimagined/v2/PermissionSaved") {}
