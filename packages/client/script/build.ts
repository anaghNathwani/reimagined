...
import { compile, emitEffectImported, emitPromise, write } from "@reimagined-ai/httpapi-codegen"
    ...
    [
      write(
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              name: "ReimaginedEventEncoded",
              import: 'import type { ReimaginedEventEncoded } from "@reimagined-ai/protocol/groups/event"',
            },
          },
        }),
