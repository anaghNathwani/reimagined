---
title: TUI
description: Bruke reimagined-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Reimagined gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre Reimagined starter TUI for gjeldende katalog.
...
Når du bruker Reimagined TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til Reimagined. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt Reimagined. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `reimagined.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge Reimagined venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `reimagined.default`.
