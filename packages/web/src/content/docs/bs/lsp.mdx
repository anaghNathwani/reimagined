---
title: LSP serveri
description: Reimagined se integriše sa vašim LSP serverima.
---

Reimagined se može integrisati sa Language Server Protocol (LSP) serverima kako bi koristio dijagnostiku kao feedback za agenta.

## Ugrađeni

Reimagined dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
...
Kada je LSP omogućen i reimagined otvori fajl, on:
...
Možete omogućiti i prilagoditi LSP servere kroz `lsp` odjeljak u vašoj reimagined konfiguraciji.
