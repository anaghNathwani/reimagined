---
title: Serveurs LSP
description: Reimagined s'intègre à vos serveurs LSP.
---

Reimagined peut s'intégrer aux serveurs Language Server Protocol (LSP) pour utiliser les diagnostics comme retour pour l'agent.

---

## Serveurs intégrés

Reimagined est livré avec plusieurs serveurs LSP intégrés pour les langages populaires :
...
Lorsque LSP est activé et qu'reimagined ouvre un fichier, il :
...
Vous pouvez activer et personnaliser les serveurs LSP via la section `lsp` de votre configuration reimagined.
