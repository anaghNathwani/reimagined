...
Crear `.reimagined/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración Reimagined o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Reimagined [config](/docs/config):
...
- Por proyecto: `.reimagined/commands/`
...
reimagined incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
