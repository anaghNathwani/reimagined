...
Reimagined è disponibile anche come applicazione desktop. Puoi scaricarla direttamente dalla [pagina delle release](https://github.com/anomalyco/reimagined/releases) oppure da [reimagined.ai/download](https://reimagined.ai/download).
...
Scopri di più sugli [agenti](https://reimagined.ai/docs/agents).

### Documentazione

Per maggiori informazioni su come configurare Reimagined, [**consulta la nostra documentazione**](https://reimagined.ai/docs).
