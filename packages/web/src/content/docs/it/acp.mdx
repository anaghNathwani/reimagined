---
title: Supporto ACP
description: Usa Reimagined in qualunque editor compatibile con ACP.
---

Reimagined supporta [Agent Client Protocol](https://agentclientprotocol.com) (ACP), permettendoti di usarlo direttamente in editor e IDE compatibili.
...
Per usare Reimagined via ACP, configura l'editor in modo che esegua il comando `reimagined acp`.

Il comando avvia Reimagined come sottoprocesso compatibile con ACP che comunica con l'editor via JSON-RPC su stdio.
...
Per aprirlo, seleziona il nuovo agente 'Reimagined' nel selettore agenti di AI Chat.
...
Per usare Reimagined come agente ACP in [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), aggiungi quanto segue alla config di Neovim:
...
Questa config imposta CodeCompanion per usare Reimagined come agente ACP per la chat.
...
Reimagined funziona via ACP come nel terminale. Tutte le funzionalita sono supportate:
:::note
...
- Server MCP configurati nella tua configurazione Reimagined
