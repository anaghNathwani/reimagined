...
Opret `.reimagined/commands/test.md`:
...
Du kan tilføje brugerdefinerede kommandoer gennem Reimagined-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din Reimagined [config](/docs/config):
...
- Globalt: `~/.config/reimagined/commands/`
- Pr. projekt: `.reimagined/commands/`
...
reimagined indeholder flere indbyggede kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
