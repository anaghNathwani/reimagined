...
- Effect plugins import `@reimagined-ai/plugin/v2/effect`, not `@reimagined-ai/core`.
- Public domain values use generated `@reimagined-ai/sdk` types.
...
- Define `PluginHost` domain capabilities in `@reimagined-ai/plugin/v2/effect`.
