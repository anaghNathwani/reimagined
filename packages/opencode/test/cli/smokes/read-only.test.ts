...
describe("reimagined read-only commands (smoke)", () => {
  ...
  cliIt.live(
    ...
    ({ reimagined }) =>
      Effect.gen(function* () {
        const r = yield* reimagined.spawn(["mcp", "list"])
        reimagined.expectExit(r, 0, "mcp list")
      }),
    60_000,
  )
  ...
  cliIt.live(
    ...
    ({ reimagined }) =>
      Effect.gen(function* () {
        const r = yield* reimagined.spawn(["providers", "list"])
        reimagined.expectExit(r, 0, "providers list")
  ...
  cliIt.live(
    ...
    ({ reimagined }) =>
      Effect.gen(function* () {
        const r = yield* reimagined.spawn(["models"])
        reimagined.expectExit(r, 0, "models")
  ...
  cliIt.live(
    ...
    ({ reimagined }) =>
      Effect.gen(function* () {
        const r = yield* reimagined.spawn(["agent", "list"])
        reimagined.expectExit(r, 0, "agent list")
      }),
    60_000,
  )
  ...
  cliIt.live(
    ...
    ({ reimagined }) =>
      Effect.gen(function* () {
        const r = yield* reimagined.spawn(["session", "list"])
        reimagined.expectExit(r, 0, "session list")
      }),
    60_000,
  )
  ...
  cliIt.live(
    ...
    ({ reimagined }) =>
      Effect.gen(function* () {
        const r = yield* reimagined.spawn(["stats"])
        reimagined.expectExit(r, 0, "stats")
      }),
    60_000,
  )
  ...
  cliIt.live(
    ...
    ({ reimagined }) =>
      Effect.gen(function* () {
        const r = yield* reimagined.spawn(["db", "path"])
        reimagined.expectExit(r, 0, "db path")
