...
description: Brug Reimagined i enhver ACP-kompatibel editor.
---

Reimagined understøtter [Agent Client Protocol](https://agentclientprotocol.com) eller (ACP), så du kan bruge det direkte i kompatible editorer og IDE'er.
...
For at bruge Reimagined via ACP, konfigurer din editor til at køre kommandoen `reimagined acp`.

Kommandoen starter Reimagined som en ACP-kompatibel underproces, der kommunikerer med din editor over JSON-RPC via stdio.
...
For at åbne den skal du bruge den nye 'Reimagined'-agent i AI Chat-agentvælgeren.
...
For at bruge Reimagined som en ACP-agent i [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), skal du tilføje følgende til din Neovim-konfiguration:
...
Denne konfiguration sætter CodeCompanion til at bruge Reimagined som ACP-agent til chat.
...
Reimagined fungerer på samme måde via ACP som i terminalen. Alle funktioner understøtter:
...
- MCP-servere konfigureret i din Reimagined-konfiguration
