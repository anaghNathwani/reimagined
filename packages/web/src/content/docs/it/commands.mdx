...
Crea `.reimagined/commands/test.md`:
...
Puoi aggiungere comandi personalizzati tramite la config di Reimagined o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Reimagined:
...
- Globale: `~/.config/reimagined/commands/`
- Per progetto: `.reimagined/commands/`
...
reimagined include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
