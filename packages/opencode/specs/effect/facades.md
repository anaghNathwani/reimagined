...
Concrete inventory of the remaining `makeRuntime(...)`-backed facades in `packages/reimagined`.
...
- [x] `../core/src/filesystem.ts` (`FileSystem`) - legacy reimagined service removed
