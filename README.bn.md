...
# Package managers
npm i -g reimagined-ai@latest        # or bun/pnpm/yarn
scoop install reimagined             # Windows
choco install reimagined             # Windows
brew install anomalyco/tap/reimagined # macOS and Linux (recommended, always up to date)
brew install reimagined              # macOS and Linux (official brew formula, updated less)
sudo pacman -S reimagined            # Arch Linux (Stable)
paru -S reimagined-bin               # Arch Linux (Latest from AUR)
mise use -g reimagined               # Any OS
nix run nixpkgs#reimagined           # or github:anomalyco/reimagined for latest dev branch
```
...
Reimagined ডেস্কটপ অ্যাপ্লিকেশন হিসেবেও উপলব্ধ। সরাসরি [রিলিজ পেজ](https://github.com/anomalyco/reimagined/releases) অথবা [reimagined.ai/download](https://reimagined.ai/download) থেকে ডাউনলোড করুন।
...
4. `$HOME/.reimagined/bin` - ডিফল্ট ফলব্যাক
...
Reimagined এ দুটি বিল্ট-ইন এজেন্ট রয়েছে যা আপনি `Tab` কি(key) দিয়ে পরিবর্তন করতে পারবেন।
...
এজেন্টদের সম্পর্কে আরও জানুন: [docs](https://reimagined.ai/docs/agents)।

### ডকুমেন্টেশন (Documentation)

কিভাবে Reimagined কনফিগার করবেন সে সম্পর্কে আরও তথ্যের জন্য, [**আমাদের ডকস দেখুন**](https://reimagined.ai/docs)।

### অবদান (Contributing)

আপনি যদি Reimagined এ অবদান রাখতে চান, অনুগ্রহ করে একটি পুল রিকোয়েস্ট সাবমিট করার আগে আমাদের [কন্ট্রিবিউটিং ডকস](./CONTRIBUTING.md) পড়ে নিন।

### Reimagined এর উপর বিল্ডিং (Building on Reimagined)

আপনি যদি এমন প্রজেক্টে কাজ করেন যা Reimagined এর সাথে সম্পর্কিত এবং প্রজেক্টের নামের অংশ হিসেবে "reimagined" ব্যবহার করেন, উদাহরণস্বরূপ "reimagined-dashboard" বা "reimagined-mobile", তবে দয়া করে আপনার README তে একটি নোট যোগ করে স্পষ্ট করুন যে এই প্রজেক্টটি Reimagined দল দ্বারা তৈরি হয়নি এবং আমাদের সাথে এর কোনো সরাসরি সম্পর্ক নেই।

---

**আমাদের কমিউনিটিতে যুক্ত হোন** [Discord](https://discord.gg/reimagined) | [X.com](https://x.com/reimagined)
