---
title: TUI
description: استخدام واجهة المستخدم TUI في Reimagined.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر Reimagined واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل Reimagined إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة Reimagined في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى Reimagined. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من Reimagined. _الأسماء المستعارة_: `/quit`, `/q`
...
هذا منفصل عن `reimagined.json`، الذي يضبط سلوك الخادم ووقت التشغيل.
...
- `leader_timeout` - يتحكم في مدة انتظار Reimagined بعد الضغط على leader key. القيمة الافتراضية `2000`.
...
- `sound_pack` - sound pack ID المراد استخدامه. القيمة الافتراضية `reimagined.default`.
