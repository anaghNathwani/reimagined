---
title: Özel Araçlar
description: LLM'un reimagined'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. reimagined'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.reimagined/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/reimagined/tools/` içine yerleştirerek.
