---
title: Zen
description: reimagined tarafından sağlanan seçilmiş modeller listesi.
---
...
Reimagined Zen, Reimagined ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

Zen, Reimagined'daki diğer sağlayıcılar gibi çalışır. Reimagined Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve Reimagined kullanmak için buna ihtiyacınız yoktur.
...
:::tip
Reimagined ile iyi çalışan seçili bir model ve sağlayıcı grubunu test ettik.
:::
...
Reimagined Zen, bu modellere erişmenizi sağlayan bir AI ağ geçididir.

---

## Nasıl çalışır

Reimagined Zen, Reimagined'daki diğer sağlayıcılar gibi çalışır.

1. **<a href={console}>Reimagined Zen</a>**'de oturum açın, faturalandırma bilgilerinizi ekleyin ve API anahtarınızı kopyalayın.
2. TUI'de `/connect` komutunu çalıştırın, Reimagined Zen'i seçin ve API anahtarınızı yapıştırın.
...
Reimagined yapılandırmanızdaki [model id](/docs/config/#models) `reimagined/<model-id>` biçimini kullanır. Örneğin, GPT 5.5 için yapılandırmanızda `reimagined/gpt-5.5` kullanırsınız.
...
- DeepSeek V4 Flash Free, sınırlı bir süre için Reimagined'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo-V2.5 Free, sınırlı bir süre için Reimagined'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- North Mini Code Free, sınırlı bir süre için Reimagined'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Ultra Free, sınırlı bir süre için Reimagined'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için Reimagined'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
Reimagined Zen'i şunlar için oluşturduk:
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca Reimagined ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.
