...
const getBase = (appId: string): Configuration => ({
  artifactName: "reimagined-desktop-${os}-${arch}.${ext}",
  directories: {
    output: "dist",
  ...
  switch (channel) {
    case "dev": {
      return {
        ...base,
        appId,
        productName: "Reimagined Dev",
        rpm: { packageName: "reimagined-dev" },
      }
    }
    case "beta": {
      return {
        ...base,
        appId,
        productName: "Reimagined Beta",
        protocols: { name: "Reimagined Beta", schemes: ["reimagined"] },
        publish: { provider: "github", owner: "anomalyco", repo: "reimagined-beta", channel: "latest" },
        rpm: { packageName: "reimagined-beta" },
      }
    }
    case "prod": {
      return {
        ...base,
        appId,
        productName: "Reimagined",
        protocols: { name: "Reimagined", schemes: ["reimagined"] },
        publish: { provider: "github", owner: "anomalyco", repo: "reimagined", channel: "latest" },
        deb: { fpm: [legacyDesktopEntryFpm] },
        rpm: { packageName: "reimagined", fpm: [legacyDesktopEntryFpm] },
      }
    }
  }
}
