...
brew install anomalyco/tap/reimagined # macOS 和 Linux（推荐，始终保持最新）
brew install reimagined              # macOS 和 Linux（官方 brew formula，更新频率较低）
sudo pacman -S reimagined            # Arch Linux (Stable)
paru -S reimagined-bin               # Arch Linux (Latest from AUR)
mise use -g reimagined               # 任意系统
nix run nixpkgs#reimagined           # 或用 github:anomalyco/reimagined 获取最新 dev 分支
```
...
Reimagined 也提供桌面版应用。可直接从 [发布页 (releases page)](https://github.com/anomalyco/reimagined/releases) 或 [reimagined.ai/download](https://reimagined.ai/download) 下载。
...
Reimagined 内置两种 Agent，可用 `Tab` 键快速切换：
...
了解更多 [Agents](https://reimagined.ai/docs/agents) 相关信息。

### 文档

更多配置说明请查看我们的 [**官方文档**](https://reimagined.ai/docs)。
...
如果你在项目名中使用了 “reimagined”（如 “reimagined-dashboard” 或 “reimagined-mobile”），请在 README 里注明该项目不是 Reimagined 团队官方开发，且不存在隶属关系。

---

**加入我们的社区** [飞书](https://applink.feishu.cn/client/chat/chatter/add_by_link?link_token=52ao9352-5623-4fa0-b7dd-3407c392c1af&qr_code=true) | [X.com](https://x.com/reimagined)
