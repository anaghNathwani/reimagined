...
Agentferdigheter lar Reimagined oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går Reimagined opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
Reimagined viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `reimagined.json`:
