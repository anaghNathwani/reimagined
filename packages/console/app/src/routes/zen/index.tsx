...
import compareVideo from "../../asset/lander/reimagined-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/reimagined-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="reimagined:auth" content={loggedin() ? "true" : "false"} />
