...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips reimagined-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-reimagined-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-reimagined-directory")).toBeNull()
      expect(result.get("x-reimagined-workspace")).toBeNull()
