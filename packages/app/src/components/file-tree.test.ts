...
beforeAll(async () => {
  ...
  mock.module("@reimagined-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@reimagined-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@reimagined-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@reimagined-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
