...
import { Entry, FileSystem, FindInput, Match } from "@reimagined-ai/schema/filesystem"
export { Entry, Match, Submatch } from "@reimagined-ai/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@reimagined/v2/FileSystem") {}
