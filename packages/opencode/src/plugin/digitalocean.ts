import type { Hooks, PluginInput } from "@reimagined-ai/plugin"
import type { Model } from "@reimagined-ai/sdk/v2"
import { InstallationVersion } from "@reimagined-ai/core/installation/version"
import { OauthCallbackPage } from "@reimagined-ai/core/oauth/page"
...
async function listRouters(
  ...
  const res = await fetch(`${DO_GENAI_API}/models/routers`, {
    headers: {
      ...
      "User-Agent": `reimagined/${InstallationVersion}`,
    },
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. Reimagined will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
