export const dict = {
  ...
  "dialog.provider.reimagined.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.reimagined.tagline": "Modèles optimisés et fiables",
  "dialog.provider.reimaginedGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Reimagined",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Reimagined.",
  ...
  "provider.connect.reimaginedZen.line1":
    "Reimagined Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.reimaginedZen.visit.prefix": "Visitez ",
  "provider.connect.reimaginedZen.visit.link": "reimagined.ai/zen",
  "provider.connect.reimaginedZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Reimagined.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Reimagined.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans reimagined.json",
  ...
  "dialog.server.description": "Changez le serveur Reimagined auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'Reimagined...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'Reimagined dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'Reimagined...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'Reimagined dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour Reimagined dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour Reimagined",
  "wsl.onboarding.reimaginedReadyIn": "Reimagined est prêt dans {{distro}}.",
  "wsl.onboarding.reimaginedReady": "Reimagined est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez Reimagined dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer Reimagined",
  ...
  "wsl.onboarding.distroStatus.reimaginedMissing": "Reimagined non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Reimagined puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Reimagined n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Reimagined.",
  ...
  "toast.update.description":
    "Une nouvelle version d'Reimagined ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Reimagined",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (reimagined.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Reimagined ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Reimagined inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Reimagined dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Reimagined",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Reimagined sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Reimagined suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Reimagined.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Reimagined",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Reimagined.",
