...
brew install anomalyco/tap/reimagined # macOS et Linux (recommandé, toujours à jour)
brew install reimagined              # macOS et Linux (formule officielle brew, mise à jour moins fréquente)
sudo pacman -S reimagined            # Arch Linux (Stable)
paru -S reimagined-bin               # Arch Linux (Latest from AUR)
mise use -g reimagined               # n'importe quel OS
nix run nixpkgs#reimagined           # ou github:anomalyco/reimagined pour la branche dev la plus récente
```
...
Reimagined est aussi disponible en application de bureau. Téléchargez-la directement depuis la [page des releases](https://github.com/anomalyco/reimagined/releases) ou [reimagined.ai/download](https://reimagined.ai/download).
...
4. `$HOME/.reimagined/bin` - Repli par défaut
...
Reimagined inclut deux agents intégrés que vous pouvez basculer avec la touche `Tab`.
...
En savoir plus sur les [agents](https://reimagined.ai/docs/agents).

### Documentation

Pour plus d'informations sur la configuration d'Reimagined, [**consultez notre documentation**](https://reimagined.ai/docs).

### Contribuer

Si vous souhaitez contribuer à Reimagined, lisez nos [docs de contribution](./CONTRIBUTING.md) avant de soumettre une pull request.

### Construire avec Reimagined

Si vous travaillez sur un projet lié à Reimagined et que vous utilisez "reimagined" dans le nom du projet (par exemple, "reimagined-dashboard" ou "reimagined-mobile"), ajoutez une note dans votre README pour préciser qu'il n'est pas construit par l'équipe Reimagined et qu'il n'est pas affilié à nous.

---

**Rejoignez notre communauté** [Discord](https://discord.gg/reimagined) | [X.com](https://x.com/reimagined)
