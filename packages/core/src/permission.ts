...
export { Effect, Rule, Ruleset } from "@reimagined-ai/schema/permission"
...
export class Service extends Context.Service<Service, Interface>()("@reimagined/v2/Permission") {}
