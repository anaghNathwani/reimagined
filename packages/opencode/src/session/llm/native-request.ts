import type { JsonSchema, LLMRequest, ProviderMetadata } from "@reimagined-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@reimagined-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @reimagined-ai/llm request objects from reimagined's session/AI SDK-shaped data.
  return LLM.request({
