...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@reimagined-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@reimagined/v2/ToolRegistry") {}
