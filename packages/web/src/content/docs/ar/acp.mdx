---
title: دعم ACP
description: استخدم Reimagined في أي محرر متوافق مع ACP.
---

يدعم Reimagined بروتوكول [Agent Client Protocol](https://agentclientprotocol.com) أو (ACP)، مما يتيح لك استخدامه مباشرة في المحررات وبيئات التطوير المتكاملة (IDEs) المتوافقة.
...
لاستخدام Reimagined عبر ACP، اضبط محررك ليشغّل الأمر `reimagined acp`.

يشغّل هذا الأمر Reimagined كعملية فرعية متوافقة مع ACP تتواصل مع محررك عبر JSON-RPC باستخدام stdio.
...
لفتحه، اختر الوكيل الجديد 'Reimagined' من محدد الوكلاء في AI Chat.
...
لاستخدام Reimagined كوكيل ACP في [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim)، أضف التالي إلى إعدادات Neovim:
...
يضبط هذا الإعداد CodeCompanion لاستخدام Reimagined كوكيل ACP للدردشة.
...
يعمل Reimagined عبر ACP بالطريقة نفسها التي يعمل بها في terminal. جميع الميزات مدعومة:
...
- خوادم MCP المضبوطة في إعدادات Reimagined
