...
brew install anomalyco/tap/reimagined # macOS i Linux (preporučeno, uvijek ažurno)
brew install reimagined              # macOS i Linux (zvanična brew formula, rjeđe se ažurira)
sudo pacman -S reimagined            # Arch Linux (Stable)
paru -S reimagined-bin               # Arch Linux (Latest from AUR)
mise use -g reimagined               # Bilo koji OS
nix run nixpkgs#reimagined           # ili github:anomalyco/reimagined za najnoviji dev branch
```
...
4. `$HOME/.reimagined/bin` - Podrazumijevana rezervna lokacija
...
Reimagined uključuje dva ugrađena agenta između kojih možeš prebacivati tasterom `Tab`.
...
Ako želiš doprinositi Reimagined-u, pročitaj [upute za doprinošenje](./CONTRIBUTING.md) prije slanja pull requesta.

### Gradnja na Reimagined-u

Ako radiš na projektu koji je povezan s Reimagined-om i koristi "reimagined" kao dio naziva, npr. "reimagined-dashboard" ili "reimagined-mobile", dodaj napomenu u svoj README da projekat nije napravio Reimagined tim i da nije povezan s nama.

---

**Pridruži se našoj zajednici** [Discord](https://discord.gg/reimagined) | [X.com](https://x.com/reimagined)
