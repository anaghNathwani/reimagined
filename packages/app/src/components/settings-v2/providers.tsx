...
const PROVIDER_NOTES = [
  { match: (id: string) => id === "reimagined", key: "dialog.provider.reimagined.note" },
  { match: (id: string) => id === "reimagined-go", key: "dialog.provider.reimaginedGo.tagline" },
...
export const SettingsProvidersV2: Component<{ onBack?: () => void }> = (props) => {
  ...
  const connected = createMemo(() => {
    return providers
      .connected()
      .filter((p) => p.id !== "reimagined" || Object.values(p.models).find((m) => m.cost?.input))
  })
                  ...
                  <div class="settings-v2-provider-lead">
                    ...
                    <div class="settings-v2-provider-copy">
                      <div class="settings-v2-provider-main">
                        ...
                        <Show when={item.id === "reimagined" || item.id === "reimagined-go"}>
