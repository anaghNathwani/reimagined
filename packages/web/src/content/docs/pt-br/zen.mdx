---
title: Zen
description: Lista selecionada de modelos fornecidos pelo Reimagined.
---
...
O Reimagined Zen é uma lista de modelos testados e verificados fornecidos pela equipe do Reimagined.

O Zen funciona como qualquer outro provedor no Reimagined. Você faz login no Reimagined Zen e recebe sua chave de API. É **completamente opcional** e você não precisa usá-lo para usar o Reimagined.
...
:::tip
Testamos um grupo selecionado de modelos e provedores que funcionam bem com o Reimagined.
:::
...
O Reimagined Zen é um gateway de AI que dá a você acesso a esses modelos.

---

## Como funciona

O Reimagined Zen funciona como qualquer outro provedor no Reimagined.

1. Você faz login no **<a href={console}>Reimagined Zen</a>**, adiciona seus dados de cobrança e copia sua chave de API.
2. Você executa o comando `/connect` no TUI, seleciona Reimagined Zen e cola sua chave de API.
...
O [model id](/docs/config/#models) na sua configuração do Reimagined usa o formato `reimagined/<model-id>`. Por exemplo, para GPT 5.5, você usaria `reimagined/gpt-5.5` na sua configuração.
...
- DeepSeek V4 Flash Free está disponível no Reimagined por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- MiMo-V2.5 Free está disponível no Reimagined por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- North Mini Code Free está disponível no Reimagined por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Nemotron 3 Ultra Free está disponível no Reimagined por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Big Pickle é um modelo stealth que está gratuito no Reimagined por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
...
4. Não ter **lock-in**, permitindo que você o use com qualquer outro agente de codificação. E sempre permitir que você use qualquer outro provedor com o Reimagined também.
