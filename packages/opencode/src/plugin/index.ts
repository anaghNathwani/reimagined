...
import { gitlabAuthPlugin as GitlabAuthPlugin } from "reimagined-gitlab-auth"
import { PoeAuthPlugin } from "reimagined-poe-auth"
...
export class Service extends Context.Service<Service, Interface>()("@reimagined/Plugin") {}
