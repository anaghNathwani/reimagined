...
export const TypeId: TypeId = "~@reimagined-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@reimagined-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@reimagined-ai/effect-sqlite-node/NodeSqliteClient")
