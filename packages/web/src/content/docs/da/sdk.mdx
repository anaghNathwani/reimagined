...
Brug den til at bygge integrasjoner og kontrollere reimagined programmatisk.
...
Opret en forekomst av reimagined:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `reimagined.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av reimagined, kan du oprete en klientforekomst for at koble til den:
