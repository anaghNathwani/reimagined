...
Utwórz `.reimagined/commands/test.md`:
...
Możesz zdefiniować polecenia w `reimagined.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji reimagined:
...
- Globalnie: `~/.config/reimagined/commands/`
- Na projekt: `.reimagined/commands/`
...
reimagined zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
