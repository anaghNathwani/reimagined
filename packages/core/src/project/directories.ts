...
import type { EffectDrizzleSqlite } from "@reimagined-ai/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@reimagined/ProjectDirectories") {}
