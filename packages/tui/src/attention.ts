...
import defaultSoundPath from "@reimagined-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@reimagined-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@reimagined-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@reimagined-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@reimagined-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@reimagined-ai/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "reimagined"
const DEFAULT_PACK_ID = "reimagined.default"
const KV_SOUND_PACK = "attention_sound_pack"
const TITLE_LIMIT = 80
const MESSAGE_LIMIT = 240
const BUILTIN_PACK: RegisteredSoundPack = {
  id: DEFAULT_PACK_ID,
  name: "Reimagined Default",
  builtin: true,
  sounds: {
