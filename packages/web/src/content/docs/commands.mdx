...
Create `.reimagined/commands/test.md`:
...
You can add custom commands through the Reimagined config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your Reimagined [config](/docs/config):
...
- Per-project: `.reimagined/commands/`
...
reimagined includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
