...
Kreiraj `.reimagined/commands/test.md`:
...
Možete dodati prilagođene komande kroz Reimagined konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Reimagined [config](/docs/config):
...
- Globalno: `~/.config/reimagined/commands/`
- Po projektu: `.reimagined/commands/`
...
Reimagined uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
