...
Practical reference for the current tool-migration state in `packages/reimagined`.
...
Tool tests should use the existing Effect helpers in `packages/reimagined/test/lib/effect.ts`:
