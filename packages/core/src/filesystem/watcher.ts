...
import { FileSystemWatcher } from "@reimagined-ai/schema/filesystem-watcher"
...
export class Service extends Context.Service<Service, Interface>()("@reimagined/v2/FileWatcher") {}
