---
title: خوادم LSP
description: يتكامل Reimagined مع خوادم LSP لديك.
---

يمكن أن يتكامل Reimagined مع خوادم Language Server Protocol (LSP) لاستخدام التشخيصات كملاحظات للوكيل.

---

## المدمجة

يأتي Reimagined مع عدة خوادم LSP مدمجة للغات الشائعة:
...
عند تفعيل LSP وفتح reimagined لملف، فإنه:
...
يمكنك تفعيل خوادم LSP وتخصيصها عبر قسم `lsp` في إعدادات reimagined.
