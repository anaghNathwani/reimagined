---
title: ACP-støtte
description: Bruk reimagined i en hvilken som helst ACP-kompatibel editor.
---

Reimagined støtter [Agent Client Protocol](https://agentclientprotocol.com) eller (ACP), slik at du kan bruke den direkte i kompatible editorer og IDE-er.
...
For å bruke Reimagined via ACP, konfigurer redigeringsprogrammet til å kjøre kommandoen `reimagined acp`.

Kommandoen starter Reimagined som en ACP-kompatibel underprosess som kommuniserer med editoren din over JSON-RPC via stdio.
...
For å åpne den, bruk den nye 'Reimagined'-agenten i AI Chat-agentvelgeren.
...
For å bruke Reimagined som en ACP-agent i [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), legg til følgende i Neovim-konfigurasjonen:
...
Denne konfigurasjonen setter opp CodeCompanion.nvim til å bruke Reimagined som ACP-agent for chat.
...
Reimagined fungerer på samme måte via ACP som i terminalen. Alle funksjoner støttes:
...
- MCP servere konfigurert i Reimagined-konfigurasjonen
