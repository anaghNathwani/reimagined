export const dict = {
  "app.title": "Ranking de uso de modelos de IA | Reimagined Data",
  "app.description":
    "Explore o uso do Reimagined Go em modelos de IA, incluindo volume de tokens, rankings, participação de mercado, preço por token, custo por sessão, taxa de cache e distribuição geográfica.",
  "app.unfurlAlt": "Logotipo do Reimagined Data sobre um fundo escuro padronizado",
  ...
  "header.githubAria": "Dar estrela ao Reimagined no GitHub",
  "header.github": "GitHub",
  "header.tryReimagined": "Experimente o Reimagined",
  ...
  "footer.homeAria": "Início do Reimagined",
  ...
  "modal.title": "Newsletter do Reimagined",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos no Reimagined Go.",
  ...
  "home.uniqueUsersDescription": "Usuários únicos diários do Reimagined Go por modelo.",
  ...
  "lab.title": "Uso e ranking de modelos de IA da {{lab}} | Reimagined Data",
  "lab.description":
    "Compare modelos da {{lab}} usados no Reimagined Go, incluindo uso de tokens, ranking de modelos, janelas de contexto, datas de lançamento, custos e dados específicos de cada modelo.",
  "lab.loadingTitle": "Laboratório de modelos",
  "lab.loadingDescription": "Lendo disponibilidade de modelos e uso recente do Reimagined.",
  "lab.notFound": "Nenhum modelo correspondeu a este laboratório.",
  "lab.heroPrefix": "Explore {{count}} modelos da {{lab}} usados no Reimagined",
  ...
  "lab.shareOfUsage": "{{share}} do uso recente do Reimagined",
  "lab.usageTitle": "Uso de tokens da {{lab}}",
  "lab.usageDescription": "Volume diário de tokens do Reimagined nos últimos dois meses.",
  ...
  "model.title": "Uso, custo e posição de {{model}} | Reimagined Data",
  "model.description":
    "Veja dados de uso de {{model}} no Reimagined Go, incluindo volume de tokens, ranking semanal, combinação de tokens, custos, taxa de cache, sessões, distribuição geográfica e modelos pares.",
  ...
  "model.catalogFallback":
    "Fatos do modelo do índice compartilhado de modelos. O uso no Reimagined Go aparece quando este modelo tiver atividade.",
  "model.unranked": "Sem classificação no uso do Reimagined Go da última semana",
  "model.ranked": "Classificado em #{{rank}} no uso do Reimagined Go da última semana",
  ...
  "model.noCurrentUsage": "Sem uso do Reimagined Go na janela de dados atual.",
  ...
  "model.overviewDescription": "Tokens recentes do Reimagined Go, usuários únicos e posição de mercado.",
  "model.noSummaryTitle": "Sem resumo de uso",
  "model.noSummaryDescription": "Este modelo ainda não tem linhas de uso do Reimagined Go.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume diário de tokens do Reimagined Go na janela recente de dois meses.",
  ...
  "model.usersDescription": "Usuários únicos diários do Reimagined Go na janela recente de dois meses.",
  ...
  "model.efficiencyDescription": "Custo, comportamento de cache e formato médio da sessão do Reimagined Go.",
  ...
  "model.geoDescription": "Tokens do modelo Reimagined Go usados por país.",
  "model.noGeoTitle": "Sem dados geográficos",
  "model.noGeoDescription": "Nenhuma linha geográfica do Reimagined Go correspondeu a este modelo.",
  "model.worldMap": "Mapa-múndi do uso de tokens do modelo por país",
  "model.peersDescription": "Modelos próximos por volume recente de tokens do Reimagined Go.",
