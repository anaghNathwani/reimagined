import reimaginedWordmarkDark from "../asset/logo-ornate-dark.svg"
...
export const githubLink = {
  ...
  apiHref: "https://api.github.com/repos/anomalyco/reimagined",
  fallbackStars: "150K",
}
export const themePreferences = ["dark", "light", "system"] as const
export const themeStorageKey = "reimagined:stats-theme"
    ...
    <header data-component="top" data-menu-open={menuOpen() ? "true" : undefined}>
      <div data-slot="header-bar">
        ...
        <div data-slot="header-actions">
          ...
          <a data-slot="header-button" data-variant="contrast" href="https://reimagined.ai/">
            <strong>{i18n.t("header.tryReimagined")}</strong>
          </a>
          <button
...
function ReimaginedMark() {
  return (
    <svg data-slot="reimagined-mark" width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
...
export function Footer(props: {
  ...
  const legal = [
    { href: "https://reimagined.ai/legal/terms-of-service", label: i18n.t("footer.terms") },
    { href: "https://reimagined.ai/legal/privacy-policy", label: i18n.t("footer.privacy") },
  ]
  const connect = [
    { href: "mailto:hello@reimagined.ai", label: i18n.t("footer.contact") },
    { href: "https://reimagined.ai/discord", label: i18n.t("footer.community") },
    { href: "https://x.com/reimagined", label: "X" },
  ...
  return (
    <footer data-component="footer">
      ...
      <div data-slot="footer-grid">
        <a data-slot="footer-mark" href="https://reimagined.ai" aria-label={i18n.t("footer.homeAria")}>
          <ReimaginedMark />
        </a>
    ...
    <div data-component="subscribe-modal" role="dialog" aria-modal="true" aria-labelledby="subscribe-title">
      ...
      <div data-slot="modal-panel">
        <div data-slot="modal-brand">
          <img data-slot="modal-logo" src={reimaginedWordmarkDark} alt="Reimagined" />
          <button
