...
export const DESKTOP_MENU: DesktopMenu[] = [
  ...
  },
  {
    ...
    label: "Help",
    items: [
      { type: "item", label: "Reimagined Documentation", href: "https://reimagined.ai/docs" },
      { type: "item", label: "Support Forum", href: "https://discord.com/invite/reimagined" },
      { type: "item", label: "Export Logs...", command: "logs.export" },
      { type: "separator" },
      {
        type: "item",
        label: "Share Feedback",
        href: "https://github.com/anomalyco/reimagined/issues/new?template=feature_request.yml",
      },
      {
        type: "item",
        label: "Report a Bug",
        href: "https://github.com/anomalyco/reimagined/issues/new?template=bug_report.yml",
      },
    ],
  },
]
