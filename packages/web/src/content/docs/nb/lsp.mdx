---
title: LSP-servere
description: reimagined integreres med LSP-serverne dine.
---

Reimagined kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.

---

## Innebygde servere

Reimagined kommer med flere innebygde LSP-servere for populære språk:
...
Når LSP er aktivert og reimagined åpner en fil, gjør den:
...
Du kan aktivere og tilpasse LSP-servere gjennom `lsp`-delen i Reimagined-konfigurasjonen.
