...
import type { Plugin as PluginRuntime } from "@reimagined-ai/plugin/v2/effect"
...
export class Service extends Context.Service<Service, Interface>()("@reimagined/v2/Plugin") {}
