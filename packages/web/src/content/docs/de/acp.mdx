...
description: Verwenden Sie Reimagined in jedem ACP-kompatiblen Editor.
---

Reimagined unterstützt [Agent Client Protocol](https://agentclientprotocol.com) oder (ACP), sodass Sie es direkt in kompatiblen Editoren und IDEs verwenden können.
...
Um Reimagined über ACP zu verwenden, konfigurieren Sie Ihren Editor für die Ausführung des Befehls `reimagined acp`.

Der Befehl startet Reimagined als ACP-kompatiblen Unterprozess, der über stdio über JSON-RPC mit Ihrem Editor kommuniziert.
...
Um es zu öffnen, verwenden Sie den neuen Agenten „Reimagined“ in der AI Chat Agent Selector.
...
Um Reimagined als ACP-Agent in [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim) zu verwenden, fügen Sie Folgendes zu Ihrer Neovim-Konfiguration hinzu:
...
Diese Konfiguration richtet CodeCompanion so ein, dass Reimagined als ACP-Agent für den Chat verwendet wird.
...
Reimagined funktioniert über ACP genauso wie im Terminal. Alle Funktionen werden unterstützt:
...
- MCP-Server, die in Ihrer Reimagined-Konfiguration konfiguriert sind
