export const dict = {
  ...
  "dialog.provider.reimagined.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.reimagined.tagline": "Modelos optimizados y fiables",
  "dialog.provider.reimaginedGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Reimagined",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Reimagined.",
  ...
  "provider.connect.reimaginedZen.line1":
    "Reimagined Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.reimaginedZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.reimaginedZen.visit.prefix": "Visita ",
  "provider.connect.reimaginedZen.visit.link": "reimagined.ai/zen",
  "provider.connect.reimaginedZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Reimagined.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Reimagined.",
  ...
  "dialog.plugins.empty": "Plugins configurados en reimagined.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Reimagined se conecta esta app.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando Reimagined...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando Reimagined en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando Reimagined...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando Reimagined en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza Reimagined en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar Reimagined",
  "wsl.onboarding.reimaginedReadyIn": "Reimagined está listo en {{distro}}.",
  "wsl.onboarding.reimaginedReady": "Reimagined está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala Reimagined en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar Reimagined",
  ...
  "wsl.onboarding.distroStatus.reimaginedMissing": "Reimagined no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Reimagined pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Reimagined no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Reimagined.",
  ...
  "toast.update.description": "Una nueva versión de Reimagined ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Reimagined",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (reimagined.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Reimagined no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Reimagined incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Reimagined dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Reimagined",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Reimagined en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Reimagined sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Reimagined.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Reimagined",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Reimagined.",
