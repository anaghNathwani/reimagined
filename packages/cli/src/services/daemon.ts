...
import { createOpencodeClient } from "@reimagined-ai/sdk/v2/client"
import { ServerAuth } from "@reimagined-ai/server/auth"
...
export class Service extends Context.Service<Service, Interface>()("@reimagined/cli/Daemon") {}
