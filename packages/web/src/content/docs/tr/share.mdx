---
title: Paylasim
description: reimagined konusmalarini genel baglantilarla paylasin.
---

reimagined'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda reimagined:
...
reimagined, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak reimagined manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `reimagined.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda reimagined kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
