...
- PR #15835: https://github.com/anomalyco/reimagined/pull/15835

## Do Not Translate (Locale Additions)

- `Reimagined` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `reimagined` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Reimagined` in prose, `reimagined` only for exact technical identifiers
...
- Avoid changing `reimagined` to `Reimagined` inside commands, URLs, package names, or code literals
