export const dict = {
  ...
  "dialog.provider.reimagined.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.reimagined.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.reimaginedGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Reimagined",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Reimagined.",
  ...
  "provider.connect.reimaginedZen.line1":
    "Reimagined Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.reimaginedZen.visit.prefix": "Visite ",
  "provider.connect.reimaginedZen.visit.link": "reimagined.ai/zen",
  "provider.connect.reimaginedZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Reimagined.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Reimagined.",
  ...
  "dialog.plugins.empty": "Plugins configurados em reimagined.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Reimagined este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o Reimagined...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o Reimagined em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o Reimagined...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o Reimagined em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o Reimagined em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o Reimagined",
  "wsl.onboarding.reimaginedReadyIn": "O Reimagined está pronto em {{distro}}.",
  "wsl.onboarding.reimaginedReady": "O Reimagined está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o Reimagined em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o Reimagined",
  ...
  "wsl.onboarding.distroStatus.reimaginedMissing": "Reimagined não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Reimagined possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Reimagined não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Reimagined novamente.",
  ...
  "toast.update.description": "Uma nova versão do Reimagined ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Reimagined",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (reimagined.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Reimagined ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Reimagined inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Reimagined dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Reimagined",
  ...
  "settings.general.row.appearance.description": "Personalize como o Reimagined aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Reimagined segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Reimagined é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Reimagined iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Reimagined.",
