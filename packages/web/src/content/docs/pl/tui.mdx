---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala reimagined.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

reimagined zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie reimagined uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI reimagined, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do reimagined. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij reimagined. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `reimagined.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo Reimagined czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `reimagined.default`.
