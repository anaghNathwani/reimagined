...
import type { Definition } from "@reimagined-ai/schema/event"
...
export const ReimaginedEvent = event.schema
export type ReimaginedEvent = typeof ReimaginedEvent.Type
export type ReimaginedEventEncoded = typeof ReimaginedEvent.Encoded
