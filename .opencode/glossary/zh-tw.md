...
- PR #13942: https://github.com/anomalyco/reimagined/pull/13942

## Do Not Translate (Locale Additions)

- `Reimagined` (preserve casing in prose; keep `reimagined` only when it is part of commands, package names, paths, or code)
- `Reimagined Zen`
- `Reimagined CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `reimagined` in prose when referring to the product name; use `Reimagined`
