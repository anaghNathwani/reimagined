export const dict = {
  ...
  "dialog.provider.reimagined.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.reimagined.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.reimaginedGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Reimagined",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Reimagined.",
  ...
  "provider.connect.reimaginedZen.line1":
    "Reimagined Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.reimaginedZen.visit.prefix": "Odwiedź ",
  "provider.connect.reimaginedZen.visit.link": "reimagined.ai/zen",
  "provider.connect.reimaginedZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Reimagined.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Reimagined.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w reimagined.json",
  ...
  "dialog.server.description": "Przełącz serwer Reimagined, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie Reimagined...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie Reimagined w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie Reimagined...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie Reimagined w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj Reimagined w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj Reimagined",
  "wsl.onboarding.reimaginedReadyIn": "Reimagined jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.reimaginedReady": "Reimagined jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj Reimagined w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj Reimagined",
  ...
  "wsl.onboarding.distroStatus.reimaginedMissing": "Reimagined nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Reimagined będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Reimagined nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Reimagined.",
  ...
  "toast.update.description": "Nowa wersja Reimagined ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Reimagined",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (reimagined.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Reimagined nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "Reimagined zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Reimagined wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Reimagined",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Reimagined na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Reimagined ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Reimagined.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Reimagined",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Reimagined.",
