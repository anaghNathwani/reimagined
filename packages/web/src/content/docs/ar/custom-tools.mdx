...
description: أنشئ أدوات يمكن لـ LLM استدعاؤها في reimagined.
---

الأدوات المخصصة هي دوال تنشئها يمكن لـ LLM استدعاؤها أثناء المحادثات. تعمل جنبا إلى جنب مع [الأدوات المدمجة](/docs/tools) في reimagined مثل `read` و`write` و`bash`.
...
- محليا بوضعها في مجلد `.reimagined/tools/` داخل مشروعك.
- أو عالميا بوضعها في `~/.config/reimagined/tools/`.
