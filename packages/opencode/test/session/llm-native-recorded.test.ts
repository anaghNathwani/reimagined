...
import { LLMEvent, LLMResponse } from "@reimagined-ai/llm"
import { RequestExecutor } from "@reimagined-ai/llm/route"
...
const RECORDED_SCENARIOS = [
  {
    ...
    tags: ["reimagined", "native", "tool-loop"],
  ...
  },
  {
    ...
    protocol: "openai-responses",
    tags: ["reimagined", "native", "oauth", "tool-loop"],
...
function recordedNativeLLMLayer(scenario: RecordedScenario) {
  ...
  // Only the HTTP client is recorded; RequestExecutor and the reimagined LLM stack remain real.
  const metadata = {
