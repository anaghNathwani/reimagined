export const dict = {
  ...
  "dialog.provider.reimagined.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.reimagined.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.reimaginedGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "Reimaginedが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Reimaginedで{{provider}}モデルを使用します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してReimaginedで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Reimaginedで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "reimagined.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するReimaginedサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "Reimaginedを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のReimaginedを確認中...",
  "wsl.onboarding.updatingOpencode": "Reimaginedを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のReimaginedを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のReimaginedを更新してください。",
  "wsl.onboarding.updateOpencode": "Reimaginedを更新",
  "wsl.onboarding.reimaginedReadyIn": "{{distro}}内のReimaginedの準備ができました。",
  "wsl.onboarding.reimaginedReady": "Reimaginedの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にReimaginedをインストールしてください。",
  "wsl.onboarding.installOpencode": "Reimaginedをインストール",
  ...
  "wsl.onboarding.distroStatus.reimaginedMissing": "Reimaginedがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ReimaginedでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Reimaginedをもう一度開いてください。",
  ...
  "toast.update.description": "Reimaginedの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをReimaginedチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (reimagined.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: ReimaginedはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Reimaginedには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でReimaginedサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Reimaginedの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのReimaginedの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Reimaginedがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Reimaginedのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Reimagined の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Reimagined は最新バージョンです。",
