...
import type { FileSearchHandle } from "@reimagined-ai/session-ui/file"
import { useFileComponent } from "@reimagined-ai/ui/context/file"
import { cloneSelectedLineRange, previewSelectedLines } from "@reimagined-ai/session-ui/pierre/selection-bridge"
import { createLineCommentController } from "@reimagined-ai/session-ui/line-comment-annotations"
import { createLineCommentControllerV2 } from "@reimagined-ai/session-ui/v2/line-comment-annotations-v2"
...
import { LineCommentV2OverflowIcon } from "@reimagined-ai/ui/v2/line-comment-v2"
  ...
  const renderFile = (source: string) => (
    <div class="relative overflow-hidden pb-40">
      <Dynamic
        ...
        search={search}
        class="select-text [--reimagined-diffs-bg:var(--v2-background-bg-base)]"
        media={{
          mode: "auto",
          path: path(),
          current: state()?.content,
