...
import type { Event, GlobalEvent, OpencodeClient } from "@reimagined-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@reimagined/RunStreamTransport") {}
