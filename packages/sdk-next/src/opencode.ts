import { Reimagined } from "@reimagined-ai/client/effect"
...
import { createEmbeddedRoutes } from "@reimagined-ai/server/routes"
import { Context, Effect, Layer, Scope } from "effect"
import { FetchHttpClient, HttpRouter, HttpServer } from "effect/unstable/http"

export const create = Effect.fn("Reimagined.create")(function* () {
  ...
  const client = yield* Reimagined.make({ baseUrl: "http://reimagined.local" }).pipe(
...
export class Service extends Context.Service<Service, Interface>()("@reimagined-ai/sdk-next/Reimagined") {}
