...
const GLOBAL_STORAGE = "reimagined.global.dat"
const WINDOW_STORAGE = "reimagined.window"
const LOCAL_PREFIX = "reimagined."
...
function workspaceStorage(dir: string) {
  ...
  return `reimagined.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `reimagined.draft.${head}.${sum}.dat`
}
