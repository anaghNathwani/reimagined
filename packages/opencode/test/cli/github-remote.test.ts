...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/reimagined.git")).toEqual({ owner: "sst", repo: "reimagined" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/reimagined")).toEqual({ owner: "sst", repo: "reimagined" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/reimagined.git")).toEqual({ owner: "sst", repo: "reimagined" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/reimagined")).toEqual({ owner: "sst", repo: "reimagined" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/reimagined.git")).toEqual({ owner: "sst", repo: "reimagined" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/reimagined")).toEqual({ owner: "sst", repo: "reimagined" })
})
