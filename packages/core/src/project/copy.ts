...
import { Event } from "@reimagined-ai/schema/project-directories"
import { ProjectCopy } from "@reimagined-ai/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@reimagined/ProjectCopy") {}
