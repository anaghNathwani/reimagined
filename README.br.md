...
O Reimagined também está disponível como aplicativo desktop. Baixe diretamente pela [página de releases](https://github.com/anomalyco/reimagined/releases) ou em [opencode.ai/download](https://opencode.ai/download).
...
Para mais informações sobre como configurar o Reimagined, [**veja nossa documentação**](https://opencode.ai/docs).
