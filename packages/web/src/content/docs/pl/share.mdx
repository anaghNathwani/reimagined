---
title: Udostępnianie
description: Udostępnij swoje rozmowy dotyczące reimagined.
---

Funkcja udostępniania reimagined umożliwia tworzenie publicznych linków do konwersacji reimagined, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.
...
Kiedy udostępniasz rozmowę, reimagined:
...
reimagined obsługuje trzy tryby udostępniania, które kontrolują sposób udostępniania rozmów:

---

### Ręczne (domyślne)

Domyślnie reimagined korzysta z ręcznego trybu udostępniania. Sesje nie są udostępniane automatycznie, ale możesz je udostępnić ręcznie za pomocą polecenia `/share`:
...
Aby wymusić to w całym zespole dla danego projektu, dodaj go do `reimagined.json` w swoim projekcie i sprawdź w Git.
...
[Dowiedz się więcej](/docs/enterprise) o używaniu reimagined w Twojej organizacji.
