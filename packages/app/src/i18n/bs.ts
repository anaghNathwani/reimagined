export const dict = {
  ...
  "dialog.provider.reimagined.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.reimagined.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.reimaginedGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Reimagined",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Reimagined-u.",
  ...
  "provider.connect.reimaginedZen.line1":
    "Reimagined Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.reimaginedZen.visit.prefix": "Posjeti ",
  "provider.connect.reimaginedZen.visit.link": "opencode.ai/zen",
  "provider.connect.reimaginedZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Reimagined-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Reimagined-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u reimagined.json",
  ...
  "dialog.server.description": "Promijeni na koji se Reimagined server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera Reimagined...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera Reimagined u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Reimagined...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Reimagined u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj Reimagined u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj Reimagined",
  "wsl.onboarding.reimaginedReadyIn": "Reimagined je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.reimaginedReady": "Reimagined je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj Reimagined u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj Reimagined",
  ...
  "wsl.onboarding.distroStatus.reimaginedMissing": "Reimagined nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Reimagined mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Reimagined nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Reimagined.",
  ...
  "toast.update.description": "Nova verzija Reimagined-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Reimagined timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (reimagined.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Reimagined još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Reimagined uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Reimagined server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Reimagined-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Reimagined izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Reimagined prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Reimagined-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Reimagined pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Reimagined-a.",
