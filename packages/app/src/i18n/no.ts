...
export const dict = {
  ...
  "dialog.provider.reimagined.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.reimagined.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.reimaginedGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Reimagined",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Reimagined.",
  ...
  "provider.connect.reimaginedZen.line1":
    "Reimagined Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.reimaginedZen.visit.prefix": "Besøk ",
  "provider.connect.reimaginedZen.visit.link": "opencode.ai/zen",
  "provider.connect.reimaginedZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Reimagined.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Reimagined.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i reimagined.json",
  ...
  "dialog.server.description": "Bytt hvilken Reimagined-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Reimagined ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Reimagined-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (reimagined.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Reimagined ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Reimagined inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Reimagined-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Reimagined",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Reimagined ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Reimagined skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Reimagined er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Reimagined starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Reimagined.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker Reimagined...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker Reimagined i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer Reimagined...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer Reimagined i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater Reimagined i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater Reimagined",
  "wsl.onboarding.reimaginedReadyIn": "Reimagined er klar i {{distro}}.",
  "wsl.onboarding.reimaginedReady": "Reimagined er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer Reimagined i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.reimaginedMissing": "Reimagined er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Reimagined kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Reimagined kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Reimagined på nytt.",
