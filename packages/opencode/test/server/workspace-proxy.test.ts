...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips reimagined-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-reimagined-directory"]).toBeUndefined()
      expect(forwarded["x-reimagined-workspace"]).toBeUndefined()
