...
Erstellen Sie `.reimagined/commands/test.md`:

```md title=".reimagined/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die Reimagined-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem Reimagined [config](/docs/config):

```json title="reimagined.jsonc" {4-12}
{
...
- Global: `~/.config/reimagined/commands/`
- Pro Projekt: `.reimagined/commands/`

```markdown title="~/.config/reimagined/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".reimagined/commands/component.md"
---
...
```md title=".reimagined/commands/create-file.md"
---
...
```md title=".reimagined/commands/analyze-coverage.md"
---
...
```md title=".reimagined/commands/review-changes.md"
---
...
```md title=".reimagined/commands/review-component.md"
---
...
Reimagined enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
