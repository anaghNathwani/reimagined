...
مع Reimagined يمكنك الاختيار من بين عدة سمات مدمجة، أو استخدام سمة تتكيّف مع سمة terminal لديك، أو تعريف سمة مخصصة خاصة بك.

افتراضيًا، يستخدم Reimagined سمتنا `reimagined`.
...
يأتي Reimagined مع عدة سمات مدمجة.
...
- يريدون أن يطابق Reimagined مظهر terminal لديهم
...
يدعم Reimagined نظام سمات مرنًا قائمًا على JSON يتيح للمستخدمين إنشاء السمات وتخصيصها بسهولة.
...
2. **مجلد ضبط المستخدم** - معرّف في `~/.config/reimagined/themes/*.json` أو `$XDG_CONFIG_HOME/reimagined/themes/*.json`
3. **مجلد جذر المشروع** - معرّف في `<project-root>/.reimagined/themes/*.json`
4. **مجلد العمل الحالي** - معرّف في `./.reimagined/themes/*.json`
