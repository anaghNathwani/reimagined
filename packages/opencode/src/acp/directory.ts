...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@reimagined/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@reimagined/ACPDirectory") {}
