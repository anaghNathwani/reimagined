...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/reimagined/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/reimagined...\n")
...
console.log("Fetching npm all-time downloads for reimagined-ai...\n")
const npmDownloads = await fetchNpmDownloads("reimagined-ai")
