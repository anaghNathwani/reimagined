...
import { isSessionNotFoundError, isUnauthorizedError, Reimagined } from "../src"

test("exposes every standard HTTP API group", () => {
  const client = Reimagined.make({ baseUrl: "http://localhost:3000" })
