...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "OPENCODE.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/reimagined/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/reimagined (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/reimagined/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/reimagined/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const OPENCODE_DB|OPENCODE_DB|OPENCODE_DEV|Global\\.Path\\.data|data =" in packages/reimagined/src (115 matches)',
  },
] as const
