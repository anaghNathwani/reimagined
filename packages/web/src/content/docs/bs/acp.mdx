---
title: ACP podrška
description: Koristite Reimagined u bilo kojem uređivaču kompatibilnom sa ACP.
---

Reimagined podržava [Agent Client Protocol](https://agentclientprotocol.com) (ACP), što vam omogućava da ga koristite direktno u kompatibilnim uređivačima i IDE-ovima.
...
Da biste koristili Reimagined putem ACP-a, konfigurirajte svoj uređivač da pokrene naredbu `reimagined acp`.

Naredba pokreće Reimagined kao ACP-kompatibilan podproces koji komunicira sa vašim uređivačem preko JSON-RPC-a kroz stdio.
...
Da biste ga otvorili, koristite novog "Reimagined" agenta u AI Chat agent selektoru.
...
Da koristite Reimagined kao ACP agenta u [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), dodajte sljedeće u svoju Neovim konfiguraciju:
...
Ova konfiguracija postavlja CodeCompanion da koristi Reimagined kao ACP chat agenta.
...
Reimagined radi isto kroz ACP kao i u terminalu. Podržane su sve funkcije:
...
- MCP serveri konfigurisani u vašoj Reimagined konfiguraciji
