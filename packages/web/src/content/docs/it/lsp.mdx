---
title: Server LSP
description: Reimagined si integra con i tuoi server LSP.
---

Reimagined può integrarsi con server Language Server Protocol (LSP) per usare la diagnostica come feedback per l'agente.

---

## Integrati

Reimagined include diversi server LSP integrati per linguaggi popolari:
...
Quando LSP è abilitato e reimagined apre un file:
...
Puoi abilitare e personalizzare i server LSP tramite la sezione `lsp` nella configurazione di reimagined.
