...
Desktop application and browser-based app issues, including `reimagined web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core reimagined server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

Reimagined Zen, Reimagined Go, and billing issues.
