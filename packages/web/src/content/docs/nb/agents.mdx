...
Det er to typer agenter i Reimagined; primære agenter og underagenter.
...
Reimagined kommer med to innebygde primære agenter, **Build** og **Plan**. Vi ser nærmere på disse nedenfor.
...
Reimagined kommer med tre innebygde underagenter, **General**, **Explore** og **Scout**. Vi skal se på dette nedenfor.

---

## Innebygd

Reimagined kommer med to innebygde primære agenter og tre innebygde underagenter.
...
Konfigurer agenter i konfigurasjonsfilen `reimagined.json`:
...
- Per prosjekt: `.reimagined/agents/`
...
Hvis ingen temperatur er spesifisert, bruker Reimagined modellspesifikke standardinnstillinger; typisk 0 for de fleste modeller, 0,55 for Qwen-modeller.
...
Denne banen er i forhold til hvor konfigurasjonsfilen er plassert. Så dette fungerer for både den globale Reimagined-konfigurasjonen og den prosjektspesifikke konfigurasjonen.
...
Modellen ID i Reimagined-konfigurasjonen din bruker formatet `provider/model-id`. For eksempel, hvis du bruker [Reimagined Zen](/docs/zen), vil du bruke `reimagined/gpt-5.1-codex` for GPT 5.1 Codex.
...
:::tip
Kjør `reimagined models` for å se en liste over tilgjengelige modeller.
:::
...
:::tip
Har du en agent du vil dele? [Send inn en PR](https://github.com/anomalyco/reimagined).
:::
