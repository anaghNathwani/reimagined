...
import { ListAnchor } from "@reimagined-ai/schema/session"
...
import { SessionDurable } from "@reimagined-ai/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@reimagined/v2/Session") {}
