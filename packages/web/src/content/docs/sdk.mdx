---
title: SDK
description: Type-safe JS client for reimagined server.
---

import config from "../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

The reimagined JS/TS SDK provides a type-safe client for interacting with the server.
Use it to build integrations and control reimagined programmatically.
...
Create an instance of reimagined:
...
You can pass a configuration object to customize behavior. The instance still picks up your `reimagined.json`, but you can override or add configuration inline:
...
If you already have a running instance of reimagined, you can create a client instance to connect to it:
