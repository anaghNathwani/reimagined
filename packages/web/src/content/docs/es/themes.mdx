...
Con Reimagined puede seleccionar uno de varios temas integrados, usar un tema que se adapte al tema de su terminal o definir su propio tema personalizado.

De forma predeterminada, Reimagined usa nuestro propio tema `reimagined`.
...
Reimagined viene con varios temas integrados.
...
- Quiere que Reimagined coincida con la apariencia de su terminal
...
Reimagined admite un sistema de temas flexible basado en JSON que permite a los usuarios crear y personalizar temas fácilmente.
...
2. **Directorio de configuración de usuario**: definido en `~/.config/reimagined/themes/*.json` o `$XDG_CONFIG_HOME/reimagined/themes/*.json`
3. **Directorio raíz del proyecto**: definido en `<project-root>/.reimagined/themes/*.json`
4. **Directorio de trabajo actual** - Definido en `./.reimagined/themes/*.json`
