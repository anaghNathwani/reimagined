// Shared type vocabulary for the direct interactive mode (`reimagined --mini`).
//
...
import type { OpencodeClient, PermissionRequest, QuestionRequest, ToolPart } from "@reimagined-ai/sdk/v2"
