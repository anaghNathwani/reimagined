export const dict = {
  ...
  "dialog.provider.reimagined.note": "Відібрані моделі, включаючи Claude, GPT, Gemini та інші",
  "dialog.provider.reimagined.tagline": "Надійні оптимізовані моделі",
  "dialog.provider.reimaginedGo.tagline": "Недорога підписка для всіх",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від Reimagined",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у Reimagined.",
  ...
  "provider.connect.reimaginedZen.line1":
    "Reimagined Zen надає доступ до відібраного набору надійних оптимізованих моделей для агентів кодування.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у Reimagined.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у Reimagined.",
  ...
  "dialog.plugins.empty": "Плагіни налаштовані в reimagined.json",
  ...
  "dialog.server.description": "Перемкніть сервер Reimagined, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingOpencode": "Перевірка Reimagined...",
  "wsl.onboarding.checkingOpencodeIn": "Перевірка Reimagined у {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Оновлення Reimagined...",
  "wsl.onboarding.updatingOpencodeIn": "Оновлення Reimagined у {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Оновіть Reimagined у {{distro}}.",
  "wsl.onboarding.updateOpencode": "Оновити Reimagined",
  "wsl.onboarding.reimaginedReadyIn": "Reimagined готовий до роботи у {{distro}}.",
  "wsl.onboarding.reimaginedReady": "Reimagined готовий до роботи.",
  "wsl.onboarding.installOpencodeIn": "Встановіть Reimagined у {{distro}}.",
  "wsl.onboarding.installOpencode": "Встановити Reimagined",
  ...
  "wsl.onboarding.distroStatus.reimaginedMissing": "Reimagined не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в Reimagined потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "Reimagined не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте Reimagined.",
  ...
  "toast.update.description": "Нова версія Reimagined ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді Reimagined",
  ...
  "error.chain.checkConfig": "Перевірте назви провайдерів/моделей у конфігурації (reimagined.json)",
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, Reimagined ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "Reimagined містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер Reimagined всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу Reimagined",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд Reimagined на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи Reimagined використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему Reimagined.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску Reimagined",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію Reimagined.",
