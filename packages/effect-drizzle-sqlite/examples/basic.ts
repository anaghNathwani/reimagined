...
class Database extends Context.Service<Database, DatabaseShape>()("@reimagined/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@reimagined/example/UserStore") {
