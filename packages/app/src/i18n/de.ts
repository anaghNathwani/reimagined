...
export const dict = {
  ...
  "dialog.provider.reimagined.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.reimagined.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.reimaginedGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Reimagined",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Reimagined zu nutzen.",
  ...
  "provider.connect.reimaginedZen.line1":
    "Reimagined Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.reimaginedZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.reimaginedZen.visit.link": "reimagined.ai/zen",
  "provider.connect.reimaginedZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Reimagined zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Reimagined zu nutzen.",
  ...
  "dialog.plugins.empty": "In reimagined.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den Reimagined-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.reimagined": "Reimagined",
  ...
  "wsl.onboarding.checkingOpencode": "Reimagined wird geprüft...",
  "wsl.onboarding.checkingOpencodeIn": "Reimagined in {{distro}} wird geprüft...",
  "wsl.onboarding.updatingOpencode": "Reimagined wird aktualisiert...",
  "wsl.onboarding.updatingOpencodeIn": "Reimagined in {{distro}} wird aktualisiert...",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie Reimagined in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Reimagined aktualisieren",
  "wsl.onboarding.reimaginedReadyIn": "Reimagined ist in {{distro}} bereit.",
  "wsl.onboarding.reimaginedReady": "Reimagined ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie Reimagined in {{distro}}.",
  "wsl.onboarding.installOpencode": "Reimagined installieren",
  ...
  "wsl.onboarding.distroStatus.reimaginedMissing": "Reimagined nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Reimagined einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Reimagined konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Reimagined erneut.",
  ...
  "toast.update.description": "Eine neue Version von Reimagined ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Reimagined-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (reimagined.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Reimagined unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "Reimagined enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "Reimagined Desktop",
  ...
  "settings.desktop.wsl.description": "Reimagined-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Reimagined ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Reimagined auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Reimagined dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Reimagined anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Reimagined automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Reimagined.",
