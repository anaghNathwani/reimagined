---
title: Zen
description: Lista seleccionada de modelos proporcionada por Reimagined.
---
...
Reimagined Zen es una lista de modelos probados y verificados proporcionada por el equipo de Reimagined.

Zen funciona como cualquier otro proveedor en Reimagined. Inicias sesión en Reimagined Zen y obtienes
...
:::tip
Probamos un grupo selecto de modelos y proveedores que funcionan bien con Reimagined.
:::
...
Reimagined Zen es un gateway de AI que te da acceso a estos modelos.

---

## Cómo funciona

Reimagined Zen funciona como cualquier otro proveedor en Reimagined.

1. Inicias sesión en **<a href={console}>Reimagined Zen</a>**, agregas tus datos de facturación
   y copias tu API key.
2. Ejecutas el comando `/connect` en la TUI, seleccionas Reimagined Zen y pegas tu API key.
...
El [identificador del modelo](/docs/config/#models) en tu configuración de Reimagined
usa el formato `reimagined/<model-id>`. Por ejemplo, para GPT 5.5, usarías
`reimagined/gpt-5.5` en tu configuración.
...
- DeepSeek V4 Flash Free está disponible en Reimagined por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- MiMo-V2.5 Free está disponible en Reimagined por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- North Mini Code Free está disponible en Reimagined por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Nemotron 3 Ultra Free está disponible en Reimagined por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Big Pickle es un modelo stealth que es gratuito en Reimagined por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
...
4. Que no haya **lock-in** al permitirte usarlo con cualquier otro agente de coding. Y permitirte siempre usar también cualquier otro proveedor con Reimagined.
