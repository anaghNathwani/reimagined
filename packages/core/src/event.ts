...
import type { Data, Definition, Payload } from "@reimagined-ai/schema/event"
...
import { Durable } from "@reimagined-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@reimagined-ai/schema/event").ID
export type { Data, Definition, Payload } from "@reimagined-ai/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@reimagined/Event") {}
