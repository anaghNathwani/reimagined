---
title: SDK
description: Typsicherer JS-Client fuer den reimagined-Server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Das reimagined JS/TS SDK bietet einen typsicheren Client fuer die Server-API.
Damit kannst du Integrationen bauen und reimagined programmatisch steuern.
...
Erstelle eine reimagined-Instanz:
...
`reimagined.json` wird weiterhin geladen, kann aber inline ueberschrieben oder erweitert werden:
...
Wenn reimagined bereits laeuft, kannst du nur einen Client erstellen und verbinden:
