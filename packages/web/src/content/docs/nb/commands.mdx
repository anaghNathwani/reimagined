...
Opprett `.reimagined/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom Reimagined-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i Reimagined [config](/docs/config):
...
- Per prosjekt: `.reimagined/commands/`
...
Reimagined inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
