...
`.reimagined/commands/test.md` oluştur:
...
reimagined işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

reimagined [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/reimagined/commands/`
- Proje başına: `.reimagined/commands/`
...
reimagined, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
