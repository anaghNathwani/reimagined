...
import { AbsolutePath, type DeepMutable } from "@reimagined-ai/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@reimagined/Agent") {}
          ...
          plan: {
            ...
            permission: Permission.merge(
              ...
              Permission.fromConfig({
                ...
                edit: {
                  "*": "deny",
                  [path.join(".reimagined", "plans", "*.md")]: "allow",
