...
import { Session } from "@reimagined-ai/sdk/v2/client"
...
import { toaster } from "@reimagined-ai/ui/toast"
...
import { retry } from "@reimagined-ai/core/util/retry"
...
import { useTheme, type ColorScheme } from "@reimagined-ai/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://reimagined.ai/desktop-feedback")}
      renderPanel={() =>
