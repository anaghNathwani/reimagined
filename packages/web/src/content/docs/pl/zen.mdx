---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez Reimagined.
---
...
Reimagined Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół Reimagined.

Zen działa jak każdy inny dostawca w Reimagined. Logujesz się do Reimagined Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z Reimagined.
:::
...
Reimagined Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

Reimagined Zen działa jak każdy inny dostawca w Reimagined.

1. Logujesz się do **<a href={console}>Reimagined Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz Reimagined Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji Reimagined używa formatu
`reimagined/<model-id>`. Na przykład dla GPT 5.5 użyjesz w konfiguracji
`reimagined/gpt-5.5`.
...
- DeepSeek V4 Flash Free jest dostępny w Reimagined przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- MiMo-V2.5 Free jest dostępny w Reimagined przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- North Mini Code Free jest dostępny w Reimagined przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Ultra Free jest dostępny w Reimagined przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w Reimagined przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
Stworzyliśmy Reimagined Zen, aby:
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w Reimagined także dowolnego innego dostawcy.
