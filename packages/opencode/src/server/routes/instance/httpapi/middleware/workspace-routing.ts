...
>()("@reimagined/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@reimagined/ExperimentalHttpApiWorkspaceRouting") {}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-reimagined-directory"] || process.cwd()
}
