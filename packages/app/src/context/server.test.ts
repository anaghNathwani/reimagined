  ...
  test("moves an existing canonical web bucket into local scope", () => {
    expect(
      migrateCanonicalLocalServerState(
        {
          list: [],
          projects: { "https://reimagined.example.com": [{ worktree: "/remote", expanded: true }] },
          lastProject: { "https://reimagined.example.com": "/remote" },
        },
        ServerConnection.Key.make("https://reimagined.example.com"),
      ),
    ).toEqual({
      list: [],
      ...
      migrateCanonicalLocalServerState(
        {
          projects: {
            ...
            "https://reimagined.example.com": [
              { worktree: "/local", expanded: true },
              { worktree: "/remote", expanded: true },
            ],
          },
          lastProject: { local: "/local", "https://reimagined.example.com": "/remote" },
        },
        ServerConnection.Key.make("https://reimagined.example.com"),
      ),
    ).toEqual({
