...
สร้าง `.reimagined/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Reimagined:
...
- ระดับผู้ใช้ (Global): `~/.config/reimagined/commands/`
- ระดับโปรเจ็กต์: `.reimagined/commands/`
...
Reimagined มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
