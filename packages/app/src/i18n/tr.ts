...
export const dict = {
  ...
  "dialog.provider.reimagined.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.reimagined.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.reimaginedGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Reimagined tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Reimagined'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.reimaginedZen.line1":
    "Reimagined Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.reimaginedZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Reimagined'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Reimagined'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler reimagined.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Reimagined sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Reimagined kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde Reimagined kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "Reimagined güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde Reimagined güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki Reimagined'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "Reimagined'u güncelle",
  "wsl.onboarding.reimaginedReadyIn": "{{distro}} içinde Reimagined hazır.",
  "wsl.onboarding.reimaginedReady": "Reimagined hazır.",
  "wsl.onboarding.installOpencodeIn": "Reimagined'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "Reimagined'u kur",
  ...
  "wsl.onboarding.distroStatus.reimaginedMissing": "Reimagined kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Reimagined'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Reimagined bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Reimagined'u tekrar açın.",
  ...
  "toast.update.description": "Reimagined'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Reimagined ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (reimagined.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Reimagined henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Reimagined ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Reimagined Masaüstü",
  ...
  "settings.desktop.wsl.description": "Reimagined sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Reimagined'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Reimagined'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Reimagined'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Reimagined'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Reimagined başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Reimagined'un en son sürümünü kullanıyorsunuz.",
