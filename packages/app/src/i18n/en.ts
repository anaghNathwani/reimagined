export const dict = {
  ...
  "dialog.provider.reimagined.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.reimagined.tagline": "Reliable optimized models",
  "dialog.provider.reimaginedGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Reimagined",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Reimagined.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.reimaginedZen.line1":
    "Reimagined Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.reimaginedZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.reimaginedZen.visit.prefix": "Visit ",
  "provider.connect.reimaginedZen.visit.link": "reimagined.ai/zen",
  "provider.connect.reimaginedZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Reimagined.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Reimagined.",
  ...
  "dialog.plugins.empty": "Plugins configured in reimagined.json",
  ...
  "dialog.server.description": "Switch which Reimagined server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Reimagined...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Reimagined in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Reimagined...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Reimagined in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Reimagined in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Reimagined",
  "wsl.onboarding.reimaginedReadyIn": "Reimagined is ready in {{distro}}.",
  "wsl.onboarding.reimaginedReady": "Reimagined is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Reimagined in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Reimagined",
  ...
  "wsl.onboarding.distroStatus.reimaginedMissing": "Reimagined not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Reimagined can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Reimagined could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Reimagined.",
  ...
  "toast.update.description": "A new version of Reimagined ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Reimagined team",
  ...
  "error.chain.checkConfig": "Check your config (reimagined.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Reimagined does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Reimagined includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Reimagined server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Reimagined",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Reimagined looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Reimagined follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Reimagined is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Reimagined launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Reimagined.",
