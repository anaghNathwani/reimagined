...
Reimagined Go er et lavkostnadsabonnement — **$5 for din første måned**, deretter **$10/måned** — som gir deg pålitelig tilgang til populære åpne kodemodeller.

Go fungerer som enhver annen leverandør i Reimagined. Du abonnerer på Reimagined Go og
...
Reimagined Go gir deg tilgang til disse modellene for **$5 for din første måned**, deretter **$10/måned**.

---

## Hvordan det fungerer

Reimagined Go fungerer som enhver annen leverandør i Reimagined.

1. Du logger inn på **<a href={console}>Reimagined Zen</a>**, abonnerer på Go, og
   kopierer din API-nøkkel.
2. Du kjører kommandoen `/connect` i TUI-en, velger `Reimagined Go`, og limer inn
   din API-nøkkel.
3. Kjør `/models` i TUI-en for å se listen over modeller som er tilgjengelige gjennom Go.

:::note
Kun ett medlem per arbeidsområde kan abonnere på Reimagined Go.
:::
...
Reimagined Go inkluderer følgende grenser:
...
[Modell-ID-en](/docs/config/#models) i din Reimagined-konfigurasjon
bruker formatet `reimagined-go/<model-id>`. For eksempel, for Kimi K3, vil du
bruke `reimagined-go/kimi-k3` i konfigurasjonen din.
...
Vi opprettet Reimagined Go for å:
...
4. Ha **ingen innelåsing** ved å la deg bruke en hvilken som helst annen leverandør med Reimagined også.
