...
//
// The saved variant persists across sessions in ~/.local/state/reimagined/model.json
...
class Service extends Context.Service<Service, VariantService>()("@reimagined/RunVariant") {}
