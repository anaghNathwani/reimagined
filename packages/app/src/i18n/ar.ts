export const dict = {
  ...
  "dialog.provider.reimagined.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.reimagined.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.reimaginedGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Reimagined",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Reimagined.",
  ...
  "provider.connect.reimaginedZen.line1":
    "يمنحك Reimagined Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Reimagined.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Reimagined.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في reimagined.json",
  ...
  "dialog.server.description": "تبديل خادم Reimagined الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من Reimagined...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من Reimagined في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث Reimagined...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث Reimagined في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث Reimagined في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث Reimagined",
  "wsl.onboarding.reimaginedReadyIn": "Reimagined جاهز في {{distro}}.",
  "wsl.onboarding.reimaginedReady": "Reimagined جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت Reimagined في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت Reimagined",
  ...
  "wsl.onboarding.distroStatus.reimaginedMissing": "Reimagined غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Reimagined من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Reimagined التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Reimagined.",
  ...
  "toast.update.description": "نسخة جديدة من Reimagined ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Reimagined",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (reimagined.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Reimagined لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Reimagined نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Reimagined داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Reimagined",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Reimagined على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Reimagined يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Reimagined.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Reimagined",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Reimagined.",
