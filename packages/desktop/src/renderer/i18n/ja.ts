export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの Reimagined を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "Reimagined のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.cli.installed.message":
    "CLI を {{path}} にインストールしました\n\nターミナルを再起動して 'reimagined' コマンドを使用してください。",
