...
description: O reimagined integra-se aos seus servidores LSP.
---

O reimagined pode se integrar a servidores Language Server Protocol (LSP) para usar diagnósticos como feedback para o agente.

---

## Integrados

O reimagined vem com vários servidores LSP integrados para linguagens populares:
...
Quando o LSP está habilitado e o reimagined abre um arquivo, ele:
...
Você pode habilitar e personalizar os servidores LSP através da seção `lsp` na sua configuração do reimagined.
