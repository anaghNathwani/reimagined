...
> current private `@reimagined-ai/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@reimagined-ai/ai`
...
- Secondary audience: Reimagined and other durable agent runtimes
...
import { LLM } from "@reimagined-ai/ai"
import { OpenAI } from "@reimagined-ai/ai/providers/openai"
...
```ts
import { Message } from "@reimagined-ai/ai"
...
import { LLM, Tool } from "@reimagined-ai/ai"
...
Reimagined and other durable runtimes need to own persistence, tool settlement,
...
```ts
import { LLM } from "@reimagined-ai/ai/promise"
import { OpenAI } from "@reimagined-ai/ai/providers/openai"
...
```ts
import { LLMSchema } from "@reimagined-ai/ai/schema"
...
```ts
import { Provider, Protocol } from "@reimagined-ai/ai/provider"
...
@reimagined-ai/ai/promise
  Promise/AsyncIterable LLM facade

@reimagined-ai/ai/schema
  serializable domain schemas

@reimagined-ai/ai/provider
  experimental Provider and Protocol authoring APIs

@reimagined-ai/ai/providers/openai
@reimagined-ai/ai/providers/anthropic
@reimagined-ai/ai/providers/google
...
```
...
| Current                                 | Proposed                                                    |
| --------------------------------------- | ----------------------------------------------------------- |
| `@reimagined-ai/llm`                      | `@reimagined-ai/ai`                                           |
...
Reimagined should migrate to `generateTurn` / `streamTurn`, preserving its durable
