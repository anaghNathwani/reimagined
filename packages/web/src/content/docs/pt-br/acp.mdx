---
title: Suporte ACP
description: Use o reimagined em qualquer editor compatível com ACP.
---

O reimagined suporta o [Agent Client Protocol](https://agentclientprotocol.com) ou (ACP), permitindo que você o utilize diretamente em editores e IDEs compatíveis.
...
Para usar reimagined via ACP, configure seu editor para executar o comando `reimagined acp`.

Este comando inicia o reimagined como um subprocesso compatível com ACP que se comunica com seu editor via JSON-RPC através do stdio.
...
Para abri-lo, use o novo agente 'reimagined' no seletor de agentes do AI Chat.
...
Para usar reimagined como um agente ACP no [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), adicione o seguinte à sua configuração do Neovim:
...
Esta configuração configura o CodeCompanion para usar reimagined como o agente ACP para chat.
...
O reimagined funciona da mesma forma via ACP como funciona no terminal. Todos os recursos são suportados:
...
- Servidores MCP configurados na sua configuração do reimagined
