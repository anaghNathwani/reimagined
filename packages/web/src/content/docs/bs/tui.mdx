---
title: TUI
description: Korištenje korisničkog interfejsa Reimagined terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Reimagined pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Reimagined pokreće TUI za trenutni direktorij.
...
Kada koristite Reimagined TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Reimagined. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Reimagined. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `reimagined.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo Reimagined čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `reimagined.default`.
